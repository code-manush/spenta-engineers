        ...
        <main className="bg-white">
            ...
            <section className="relative py-50 bg-graphite text-white overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-6">
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold mb-6">Locking Coupling</h1>
            ...
            <div className="max-w-7xl mx-auto px-6 py-24 space-y-24">
                ...
                <section className="mb-20">
                    ...
                    <p className="max-w-4xl text-lg text-gray-700 leading-relaxed">
                        Locking couplings play a vital role in maintaining secure connections within a core drilling system. Installed as part of the internal assembly, they prevent unintentional disengagement of components during drilling and retrieval operations. Proper locking coupling selection ensures system integrity, operational safety, and reliable core recovery.
                    </p>
                </section>
                ...
                <section className="mb-20">
                    ...
                    <div className="max-w-4xl space-y-6 text-lg text-gray-700">
                        <p className="leading-relaxed">
                            Locking couplings are manufactured in standard sizes including AQ, BQ, NQ, HQ, and PQ. Components are produced from high-strength alloy steel using precision machining processes. Controlled heat treatment enhances strength, wear resistance, and durability under repeated loading conditions.
                        </p>
                    </div>
                </section>
                        ...
                        <table className="w-full">
                            <tbody className="text-lg">
                                {[
                                    ...
                                    { label: "Function", value: "Secures internal drilling assemblies" },
                                    { label: "Connection Type", value: "Mechanical latching mechanism" },
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
                    ...
                    <div className="bg-white p-8 rounded-sm border-2 border-gray-200 shadow-lg">
                        ...
                        <ul className="space-y-4">
                            {[
                                "Prevents accidental disengagement of internal components",
                                "Ensures secure and stable drilling operations",
                                "Precision-machined for accurate fit and alignment",
                                "Designed for repeated use in demanding field conditions"
                            ].map((item, idx) => (
                                <li key={idx} className="flex items-start gap-3 text-gray-700">
                ...
                <section className="bg-blue-50 p-12 rounded-sm border-2 border-blue-200 mb-20 shadow-lg">
                    ...
                    <p className="max-w-4xl text-lg text-gray-700 leading-relaxed">
                        Locking couplings must be compatible with the selected head assembly, overshot, and core barrel components. All locking couplings supplied by Spenta Engineers are designed to integrate seamlessly within standard core drilling systems of corresponding sizes.
                    </p>
                </section>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                        <div>
                            <h3 className="text-3xl font-bold mb-2">
                                Request a Quote for Locking Coupling
                            </h3>
                            <p className="text-gray-300 text-lg">
                                Share your drilling requirements and system configuration, and our technical team will assist you in selecting the appropriate locking coupling for your application.
                            </p>
                        </div>
                        <div className="flex flex-col sm:flex-row gap-4">
                            <RequestQuoteModal productName="Locking Coupling" sizes={[{ size: "AQ" }, { size: "BQ" }, { size: "NQ" }, { size: "HQ" }, { size: "PQ" }]} />
                            <AddToCartButton productName="Locking Coupling" />
                        </div>
                    </div>
                </section>
