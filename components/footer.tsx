...
import { Check, Mail, Phone, ArrowUp } from 'lucide-react';
...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-graphite via-black to-graphite text-white overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <form onSubmit={handleSubscribe} className="flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={subscribed}
                  className="px-6 py-3 bg-accent hover:bg-blue-700 rounded-sm font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {subscribed ? (
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <a
                    ...
                    className="w-10 h-10 rounded-sm bg-white/5 border border-white/10 hover:bg-accent hover:border-accent flex items-center justify-center transition-all hover:scale-110 group"
                  >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <a href="mailto:spentaeng@gmail.com" className="flex items-start gap-3 text-gray-400 hover:text-white transition-colors group">
                  <div className="w-10 h-10 rounded-sm bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-accent group-hover:border-accent transition-all">
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 w-12 h-12 bg-accent hover:bg-blue-700 rounded-sm shadow-xl flex items-center justify-center transition-all hover:scale-110 group z-50"
        aria-label="Back to top"
      >
        <ArrowUp className="w-6 h-6 text-white group-hover:-translate-y-1 transition-transform" strokeWidth={2} />
      </button>
    </footer>
  );
}